...
thePred = scaler.transform([[200000.0, 1000000.0]])
print 'The rescaled value for salary of 200000 is:', thePred

### c luster here; create predictions of the cluster labels
### for the data and store them to a list called pred

from sklearn.cluster import KMeans
kmeans = KMeans(n_clusters=2, n_init=10, max_iter=50).fit(scaled_finance_features)
...
try:
    Draw(pred, scaled_finance_features, poi, mark_poi=False, name="clusters_with_other_feature.pdf", f1_name=feature_1,
         f2_name=feature_2)
except NameError:
